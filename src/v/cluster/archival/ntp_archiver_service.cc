...
ss::future<> ntp_archiver::upload_until_term_change_legacy() {
    ...
    while (may_begin_uploads()) {
        ...
        // After TS→CT migration the archiver is kept alive for GC (expiring
        // old TS segments) but must not upload new segments: post-migration
        ...
        // CT records invisible to read_committed consumers.
        bool uploads_paused
