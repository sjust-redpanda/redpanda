...
// metastore.h transitively provides l1::imported_segment_info (via
// common/object_id.h) and l1::migration_phase (via metastore/state.h), whose
// packages are not directly visible here.
