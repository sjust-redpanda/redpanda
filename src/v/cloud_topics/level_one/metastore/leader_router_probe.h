...
public:
    ...
    auto_measure_append_imported_objects() {
        return _append_imported_objects.auto_measure();
    }
    ...
    std::unique_ptr<hist_t::measurement> auto_measure_set_migration_phase() {
        return _set_migration_phase.auto_measure();
    }
...
private:
    hist_t _add_objects;
    hist_t _append_imported_objects;
