...
// imported extent's base (a non-zero migration start), threads
// imported_segment_info onto the object + extent rows, and marks the partition
// migrating. Objects are created directly (footer_pos 0, not preregistered). A
