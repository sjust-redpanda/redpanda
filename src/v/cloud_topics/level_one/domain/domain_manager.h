...
public:
    ...
    virtual ss::future<rpc::append_imported_objects_reply>
      append_imported_objects(rpc::append_imported_objects_request) = 0;
    ...
    virtual ss::future<rpc::set_migration_phase_reply>
      set_migration_phase(rpc::set_migration_phase_request) = 0;
