...
public:
    ...
    public:
        ...
        // still migrating tiered->cloud (partition_storage_mode is still
        // tiered, so cloud_topic_enabled() is false until cutover). Its ctp_stm
        // is idle and housekeeping would seed a meaningless reconciled offset
        // and pin GC.
