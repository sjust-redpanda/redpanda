...
class ImportedTsSegmentInfo(google.protobuf.message.Message):
    ...
    def __init__(self, *, segment_term: builtins.int=..., delta_base: builtins.int=...) -> None:
        ...

    def ClearField(self, field_name: typing.Literal['delta_base', b'delta_base', 'segment_term', b'segment_term']) -> None:
        ...
